...
window.addEventListener("load", function(){
    ...
    form.formulario.addEventListener("submit", function(){
        ...
        let sku = document.querySelector("imput.form-control");
        if(sku.value.length == "" ){
        ...
        let nombre = document.querySelector("input.form-row.productos");
        if(nombre.value.length < 5){
            errores.push("El campo producto/nombre debe tener más de 5 caracteres");
        }

        let categoria = document.querySelector("select.categoria_Id")
         if(categoria.value == "" ){
        ...
        let volumen = document.querySelector("select.volumen");
        if(volumen.value == "" ){
        ...
        let descripcion = document.querySelector("label.descripcion");
